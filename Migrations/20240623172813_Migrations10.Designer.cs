...
namespace BlazorApp.Migrations
{
    ...
    [Migration("20240623172813_Migrations10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApp.Areas.Identity.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b51487d0-0fbb-4ed3-a0c0-b3b3d0de39e9",
                            Name = "admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "f9373323-c0c7-4d92-8033-6cd7117c8433",
                            Name = "user",
                            NormalizedName = "user"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorApp.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
